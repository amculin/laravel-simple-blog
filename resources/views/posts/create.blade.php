                        ...
                        <form method="post" action="{{ route('posts.store') }}" class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="content" name="content" class="mt-1 block w-full border-gray-300 focus:border-indigo-500
                                    focus:ring-indigo-500 rounded-md shadow-sm" rows="6"></textarea>
                                @error('content')
                                <x-input-error :messages="$message" class="mt-2" />
                                @enderror
                            </div>
                            ...
                            <div>
                                <label for="is_draft" class="inline-flex items-center">
                                    <input id="is_draft" type="checkbox" value="1" class="rounded border-gray-300 text-indigo-600
                                        shadow-sm focus:ring-indigo-500" name="is_draft">
